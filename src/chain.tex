...
in $V \setminus N$.  The edge $e$ is directed towards $v_e$, if
...
\end{theorem}
%\begin{proof}
%The running time of the algorithm follows from the discussion above,
%the correctness of the algorithm follows directly from the fact that
%there is a correct orientation among the $k!$ possible once that
%corresponds to the optimal placement
%
%\qed
%\end{proof}
