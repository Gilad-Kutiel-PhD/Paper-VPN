...
$$
ft(v_1, v_2, \alpha_1, \alpha_2, b_1, b_2) =
\begin{cases} 
\min_{\substack{\\ u_1, u_2: \\ b(u_1, v_1) \geq b_1 \\ b(u_2, v_2) \geq b_2}}
ft(u_1, u_2, \alpha_1, \alpha_2, b_1, b_2)
\\
\text{Two more cases here...}
\\
\min_{\substack{
\\ 
(\gamma_1, \beta_1), (\gamma_2, \beta_2) \in \calE,
\\
u_1, u_2:
\beta_1 \prec \alpha_1, \beta_2 \prec \alpha_2,
\\
b(u_1, v_1) \ge b(\gamma_1, \beta_1)
\\  
b(u_2, v_2) \ge b(\gamma_2, \beta_2)
}}
ft(u_1, u_2, \beta_1, \beta_2, b(\gamma_1, \beta_1), b(\gamma_2, \beta_2))
\end{cases}
$$
